...
& "$scriptPath\..\devtools\Tools\xRMCIFramework\PluginRegistration.ps1" -Verbose -CrmConnectionString "$CrmConnectionString" -AssemblyPath "$AssemblyPath" -MappingJsonPath "$MappingJsonPath" -solutionName "Customizations"
